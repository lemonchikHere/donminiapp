...
class AIAssistantService:
        ...
        tools = [
            {
                ...
                "function": {
                    ...
                    "description": (
                        "Searches for real estate properties " "based on user criteria."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {
                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "You are a real estate assistant for Don Estate. "
                            "You can answer questions about the agency and "
    ...
    async def _perform_property_search(self, args: Dict) -> Dict[str, Any]:
        ...
        if args.get("transaction_type"):
            query = query.filter(
                Property.transaction_type == args.get("transaction_type")
            )
