...
# Set dummy environment variables FIRST to avoid loading real ones from .env
...
from tests.models import Base as TestBase
...
def db_session():
    ...
    AppBase.metadata.create_all(
        bind=engine, tables=[User.__table__, Favorite.__table__]
    )
